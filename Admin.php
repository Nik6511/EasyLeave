...
if (isset($_POST['submit'])) {
  ...
  if ($password == $password1) {
    $sql = "INSERT INTO `signup` (`fname`, `lname`, `userid`, `password1`, `department`, `city`, `gender`, `age`) VALUES ('$fname', '$lname', '$userid', '$password', '$dept', '$city', '$gender', '$age')";
                ...
                <table class="table table-striped table-sm">
                  ...
                  <tbody id="pop">
                    ...
                    <tr>
                      ...
                      <td><button class="btn btn-primary btn-sm" onclick="location.href='Status.php?id=<?php echo $res['Serial'] ;?>';">Approve</button></td>
                      <td><button class="btn btn-danger btn-sm" onclick="location.href='Status1.php?id=<?php echo $res['Serial'] ;?>';">Reject</button></td>
                    </tr>
                    <?php
            }
                    ?>
